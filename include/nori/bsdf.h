...
public:
    ...
    virtual Color3f sampleMipmap(BSDFQueryRecord &bRec, const Point2f &sample, float mipmapLevel) const {
        return Color3f(0.0f);
    }
    virtual Color3f evalMipmap(const BSDFQueryRecord &bRec, float mipmapLevel) const {
        return Color3f(0.0f);
    }
